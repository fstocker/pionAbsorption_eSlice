...
//
//Variation of initKE +- 25.5MeV
//Variation of interKE +- 28.5MeV
//
//==============================================================================

void unfoldSystematic_bayes_minusEnergy(const string mcFilepath, const string dataPath, bool doMC = false, bool doXS = true)
{
   ...
   auto frame_train = frame
      ...
      .Define("syst_minusEnergy_initKE", "reco_initKE_rwData - 25.5")
      .Define("syst_minusEnergy_interKE", "reco_interKE_rwData - 28.5");
   ...
   ,{"true_initKE", "true_interKE", "syst_minusEnergy_initKE", "syst_minusEnergy_interKE", 
   ...
   TH1D* hMeas_data_initE= new TH1D ("syst_minusEnergy_initKE", "; Energy [MeV]; Events / 50 MeV", nBin_int, eEnd, eStart);

   TH1D* hTrue_interE= new TH1D ("trueMC_interE", "MC True; Energy [MeV]; Events / 50 MeV",    nBin_int, eEnd, eStart);
   TH1D* hMeas_data_interE= new TH1D ("syst_minusEnergy_interKE", "Measured data Run 58XX interE; Energy [MeV]; Events / 50 MeV", nBin_int, eEnd, eStart);

   TH1D* hTrue_abs= new TH1D ("trueMC_abs", "MC True; Energy [MeV]; Events / 50 MeV",    nBin_int, eEnd, eStart);
   TH1D* hMeas_data_abs= new TH1D ("syst_minusEnergy_abs", "Measured data Run 58XX absorption; Energy [MeV]; Events / 50 MeV", nBin_int, eEnd, eStart);
   ...
   hUnfold_initE->SetNameTitle("hSystUnfold_minusEnergy_initE", "; Energy [MeV]; Events / 50 MeV");
   hUnfold_interE->SetNameTitle("hSystUnfold_minusEnergy_interE", "; Energy [MeV]; Events / 50 MeV");
   hUnfold_abs->SetNameTitle("hSystUnfold_minusEnergy_abs", "; Energy [MeV]; Events / 50 MeV");
   ...
   TH2D* corr_initE = new TH2D("corr_syst_minusEnergy_initE", "Correlations Init E; Pion initE [MeV];Pion initE [MeV];", nb_initE, eEnd, eStart, nb_initE, eEnd, eStart);
   ...
   TH2D* corr_interE = new TH2D("corr_syst_minusEnergy_interE", "Correlations Inter E; Pion interE [MeV];Pion interE [MeV];", nb_interE, eEnd, eStart, nb_interE, eEnd, eStart);
   ...
   TH2D* corr_abs = new TH2D("corr_syst_minusEnergy_abs", "Correlations Abs; Absorption interE [MeV];Absorption interE [MeV] E", nb_abs, eEnd, eStart, nb_abs, eEnd, eStart);
   ...
   legend_initE->AddEntry(hUnfold_initE, "Unfold Syst minusEnergy");
   ...
   legend_interE->AddEntry(hUnfold_interE, "Unfold Syst minusEnergy");
   ...
   legend_abs->AddEntry(hUnfold_abs, "Unfold Syst minusEnergy");
   ...
   TCanvas* c_initE= new TCanvas("cSyst_minusEnergy_initE","cSyst_minusEnergy_initE", 1100, 800);
   gPad->SetGrid(1,1);
   ...
   TCanvas* c_interE= new TCanvas("cSyst_minusEnergy_interE","cSyst_minusEnergy_interE", 1100, 800);
   gPad->SetGrid(1,1);
   ...
   TCanvas* c_abs= new TCanvas("cSyst_minusEnergy_abs","cSyst_minusEnergy_abs", 1100, 800);
   gPad->SetGrid(1,1);
   ...
   TH1D* hUnfold_incident= new TH1D ("hSystUnfold_minusEnergy_incident", "; Energy [MeV]; Events / 50 MeV", nBin_int, eEnd, eStart);
   ...
   legend_incident->AddEntry(hUnfold_incident, "Unfold Syst minusEnergy");
   ...
   TCanvas* c_incident= new TCanvas("cSyst_minusEnergy_incident","cSyst_minusEnergy_incident", 1100, 800);
   gPad->SetGrid(1,1);
...
#ifndef __CINT__
int main () { unfoldSystematic_bayes_minusEnergy(mcPath, dataPath); return 0; }  // Main program when run stand-alone
#endif
